...
CREATE TABLE trending_sources (
  ...
  source TEXT NOT NULL CHECK (source IN ('hackernews', 'reddit', 'google_trends', 'devto', 'producthunt', 'techcrunch', 'theverge', 'newsapi', 'newsapi_technology', 'newsapi_entertainment', 'newsapi_business', 'newsapi_health', 'newsapi_science', 'newsapi_general', 'category_fill')),
