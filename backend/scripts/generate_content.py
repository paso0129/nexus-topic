...
- 하나의 기사에 서로 관련 없는 이슈를 억지로 엮지 말 것 — 주제 하나에 집중. 예를 들어 "베네수엘라 정치 + 국제유가 + 코스피"처럼 느슨한 연결고리로 다른 주제를 끌어들이지 마세요
...
- FAQ에서도 할루시네이션 절대 금지 — 미출시 제품의 "예상 스펙", 존재하지 않는 기능/모델명을 만들어내지 말 것
- "~될 것으로 전망한다", "~될 예정이다" 같은 미래 예측을 사실처럼 쓰지 말 것
- 확인된 사실만 답변에 포함. 모르면 FAQ에서 빼는 게 낫다
