...
기사 본문 최하단(모든 본문 h2/h3 섹션 뒤)에 반드시 "핵심 3줄 요약" 섹션을 추가하세요.
정확히 아래 HTML 구조를 그대로 사용하세요 (클래스명·태그 변경 금지):
<div class="article-summary">
<h3>📌 핵심 3줄 요약</h3>
<ol>
<li>첫 번째 핵심 문장 — 이 기사가 전하는 가장 중요한 사실 한 줄 (수치/주체 명확히)</li>
<li>두 번째 핵심 문장 — 배경이나 파급 효과 한 줄</li>
<li>세 번째 핵심 문장 — 독자에게 의미 있는 시사점 한 줄</li>
</ol>
</div>

요약 작성 규칙:
- 각 문장은 40~70자, 한 줄에서 완결될 것
- 수동태·추상 표현 금지. 구체적 주체·수치·연도 포함
- "주목된다", "지켜봐야 한다" 등 상투어 금지
- 본문에 나온 사실만 사용, 새 정보 추가 금지
- 별도 "출처 및 참고자료" 섹션은 만들지 말 것 (본문 인라인 링크로 충분)
"""
